...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/wandering-disk-bedc)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/wandering-disk-bedc
```

A live public deployment of this template is available at [https://wandering-disk-bedc.templates.workers.dev](https://wandering-disk-bedc.templates.workers.dev)
